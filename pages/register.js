...
const register = () => {
  ...
  const [session, loading] = useSession();
    ...
    return (
        <div>
            <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-gradient-to-r from-gray-700 via-gray-800 to-black">
    ...
    <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
      ...
      <form className="space-y-6" action="/api/register" method="POST">
        ...
        <div>
          ...
          <div className="mt-1">
            <input id="password-two" name="password-two" type="password" autoComplete="current-password" required className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
          </div>
        </div>
      ...
      <div className="mt-6">
        ...
        <div className="mt-6 grid grid-cols-2 gap-3 flex">
          <div>
